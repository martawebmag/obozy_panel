...
@section('content')
<div class="min-h-screen bg-slate-100 text-gray-800 font-sans">


    <!-- 🌅 HERO SECTION -->
    <section class="max-w-7xl mx-auto px-8 py-20 md:py-28 flex flex-col md:flex-row items-center gap-12">
        <div class="md:w-1/2">
            ...
            <a href="{{ route('stypendysci.index') }}"
               class="inline-flex items-center gap-2 px-7 py-3 bg-gradient-to-r from-blue-900 to-blue-700 text-white font-semibold rounded-full shadow-md hover:shadow-lg hover:scale-103 transition">
                <i class="fas fa-clipboard-check"></i> Formularz zapisów
            </a>
        </div>
