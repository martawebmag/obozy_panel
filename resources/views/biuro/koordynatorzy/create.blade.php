                ...
                <form method="POST" action="{{ route('koordynatorzy.store') }}">
                    ...
                    <div class="mb-4">
                        ...
                        <select name="diocese"
                            ...
                            <option value="białostocka"     @selected(old('diocese')=='białostocka')>Białostocka</option>
                            <option value="kielecka"        @selected(old('diocese')=='kielecka')>Kielecka</option>
                            <option value="krakowska"       @selected(old('diocese')=='krakowska')>Krakowska</option>
                            <option value="lubelska"        @selected(old('diocese')=='lubelska')>Lubelska</option>
                            <option value="warszawska"      @selected(old('diocese')=='warszawska')>Warszawska</option>
                            <option value="wrocławska"      @selected(old('diocese')=='wrocławska')>Wrocławska</option>
